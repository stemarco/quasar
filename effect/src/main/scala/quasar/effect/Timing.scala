...
object Timing {
  ...
  final class Ops[S[_] <: ACopK](implicit S: Timing :<<: S)
  ...
  object Ops {
    implicit def apply[S[_] <: ACopK](implicit S: Timing :<<: S): Ops[S] =
      new Ops[S]
  }

  final class LowLevel[S[_] <: ACopK](implicit S: Timing :<<: S)
    extends LiftedOps[Timing, S] {
  ...
  object LowLevel {
    implicit def apply[S[_] <: ACopK](implicit S: Timing :<<: S): LowLevel[S] =
      new LowLevel[S]
  }
